...
@Component({
	selector: 'disease-contact-form-widget',
	templateUrl: './disease-contact-form-widget.component.html'
})
export class DiseaseContactFormWidgetComponent extends DataFormWidget {
