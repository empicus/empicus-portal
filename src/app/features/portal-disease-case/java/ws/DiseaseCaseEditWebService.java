 ...
 */
@Stateless
@WebServiceProvider(name = "diseaseCaseEdit")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_POST })
public class DiseaseCaseEditWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		data.setCode(code);
		diseaseCaseService.update(code, data);
