...
export class ConversationListContainerController  {

    uiTableData: UiTableData;
    
    onUiComponentInit(uiContextData: UiContextData<AbstractData>) {
        this.uiTableData = new UiTableData('conversationList');
    ...
    onTableRowClickedEvent(data: UiEventData) {
        ...
        if(ObjectUtils.isValid(rowData)) {
            ...
            let detailsRoute = '/portal-conversation/view-conversation/' + code;
