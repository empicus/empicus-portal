...
@Component({
	selector: 'disease-contact-edit-widget',
	templateUrl: './disease-contact-edit-widget.component.html'
})
export class DiseaseContactEditWidgetComponent extends DataFormWidget {
