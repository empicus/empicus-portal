...
@Component({
	selector: 'content-order-form-widget',
	templateUrl: './content-order-form-widget.component.html'
})
export class ContentOrderFormWidgetComponent extends DataFormWidget {
