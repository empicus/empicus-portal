...
@Component({
	selector: 'content-order-edit-widget',
	templateUrl: './content-order-edit-widget.component.html'
})
export class ContentOrderEditWidgetComponent extends DataFormWidget {
