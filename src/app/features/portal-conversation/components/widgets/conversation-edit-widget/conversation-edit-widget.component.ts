...
@Component({
	selector: 'conversation-edit-widget',
	templateUrl: './conversation-edit-widget.component.html'
})
export class ConversationEditWidgetComponent extends DataFormWidget {
