 ...
 */
@Stateless
@WebServiceProvider(name = "contentOrderCreate")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_POST })
public class ContentOrderCreateWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		data.setCode(code);
		contentOrderService.create(data);
