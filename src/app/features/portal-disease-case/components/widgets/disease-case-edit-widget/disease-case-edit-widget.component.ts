...
@Component({
	selector: 'disease-case-edit-widget',
	templateUrl: './disease-case-edit-widget.component.html'
})
export class DiseaseCaseEditWidgetComponent extends DataFormWidget {
