 ...
 */
@Stateless
@WebServiceProvider(name = "academicOrderEditFormData")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_POST })
public class AcademicOrderEditFormResolverWebService extends AbstractWebService implements WebService {
