...
export class DiseaseCaseListContainerController  {

    uiTableData: UiTableData;
    
    onUiComponentInit(uiContextData: UiContextData<AbstractData>) {
        this.uiTableData = new UiTableData('diseaseCaseList');
    ...
    onTableRowClickedEvent(data: UiEventData) {
        ...
        if(ObjectUtils.isValid(rowData)) {
            ...
            let detailsRoute = '/portal-disease-case/view-disease-case/' + code;
