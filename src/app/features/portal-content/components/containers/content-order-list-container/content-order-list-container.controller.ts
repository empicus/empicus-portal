...
export class ContentOrderListContainerController  {

    uiTableData: UiTableData;
    
    onUiComponentInit(uiContextData: UiContextData<AbstractData>) {
        this.uiTableData = new UiTableData('contentOrderList');
    ...
    onTableRowClickedEvent(data: UiEventData) {
        ...
        if(ObjectUtils.isValid(rowData)) {
            ...
            let detailsRoute = '/portal-content/view-content-order/' + code;
