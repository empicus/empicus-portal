...
export class DiseaseContactListContainerController  {

    uiTableData: UiTableData;
    
    onUiComponentInit(uiContextData: UiContextData<AbstractData>) {
        this.uiTableData = new UiTableData('diseaseContactList');
    ...
    onTableRowClickedEvent(data: UiEventData) {
        ...
        if(ObjectUtils.isValid(rowData)) {
            ...
            let detailsRoute = '/portal-disease-contact/view-disease-contact/' + code;
