 ...
 */
@Stateless
@WebServiceProvider(name = "reportDelete")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_DELETE })
public class ReportDeleteWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		reportService.delete(webRequestData.getCode());
