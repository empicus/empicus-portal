 ...
 */
@Stateless
@WebServiceProvider(name = "academicOrderCreate")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_POST })
public class AcademicOrderCreateWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		data.setCode(code);
		academicOrderService.create(data);
