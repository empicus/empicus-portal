 ...
 */
@Stateless
@WebServiceProvider(name = "pathogenEdit")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_POST })
public class PathogenEditWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		data.setCode(code);
		pathogenService.update(code, data);
