...
@Component({
	selector: 'academic-order-edit-widget',
	templateUrl: './academic-order-edit-widget.component.html'
})
export class AcademicOrderEditWidgetComponent extends DataFormWidget {
