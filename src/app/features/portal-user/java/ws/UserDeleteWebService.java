 ...
 */
@Stateless
@WebServiceProvider(name = "userDelete")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_DELETE })
public class UserDeleteWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		userService.delete(webRequestData.getCode());
