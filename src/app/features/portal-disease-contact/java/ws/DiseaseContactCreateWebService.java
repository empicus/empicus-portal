 ...
 */
@Stateless
@WebServiceProvider(name = "diseaseContactCreate")
@WebServiceAllowedMethods(names = { WebConstants.REQUEST_METHOD_HTTP_POST })
public class DiseaseContactCreateWebService extends AbstractWebService implements WebService {
	...
	protected ResponsePayloadData doExecute(RequestData requestData) throws BusinessServiceException {
		...
		data.setCode(code);
		diseaseContactService.create(data);
